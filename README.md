...
- [paperclip-plugin-trello-sync](https://github.com/Wizarck/paperclip-plugin-trello-sync) — Two-way sync between Paperclip issues and Trello cards with configurable list mapping, priority labels, and feature toggles.
